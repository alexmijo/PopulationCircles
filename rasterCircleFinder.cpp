  ...
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        if (radius >= 14100) {
            ...
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.7167) * 0.679;
            cutoff64 = 1 - (1 - 0.9033) * 0.204;
            cutoff16 = 1 - (1 - 0.9962) * 0.189;
            cutoff4 = 1 - (1 - 0.9991) * 0.144;
        } else if (radius >= 11000) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.7) * 0.679;
            cutoff64 = 1 - (1 - 0.9) * 0.214;
            cutoff16 = 1 - (1 - 0.9961) * 0.189;
            cutoff4 = 1 - (1 - 0.9987) * 0.144;
        } else if (radius >= 9925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6667) * 0.679;
            cutoff64 = 1 - (1 - 0.8833) * 0.234;
            cutoff16 = 1 - (1 - 0.9914) * 0.199;
            cutoff4 = 1 - (1 - 0.9969) * 0.154;
        } else if (radius >= 8850) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.65) * 0.679;
            cutoff64 = 1 - (1 - 0.875) * 0.254;
            cutoff16 = 1 - (1 - 0.98905) * 0.209;
            cutoff4 = 1 - (1 - 0.9958) * 0.164;
        } else if (radius >= 7775) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6167) * 0.689;
            cutoff64 = 1 - (1 - 0.865) * 0.274;
            cutoff16 = 1 - (1 - 0.9843) * 0.224;
            cutoff4 = 1 - (1 - 0.9937) * 0.174;
        } else if (radius >= 6700) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6) * 0.699;
            cutoff64 = 1 - (1 - 0.86) * 0.294;
            cutoff16 = 1 - (1 - 0.982) * 0.244;
            cutoff4 = 1 - (1 - 0.9926) * 0.194;
        } else if (radius >= 5313) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.57) * 0.699;
            cutoff64 = 1 - (1 - 0.8511) * 0.329;
            cutoff16 = 1 - (1 - 0.9811) * 0.279;
            cutoff4 = 1 - (1 - 0.991) * 0.199;
        } else if (radius >= 3925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.555) * 0.699;
            cutoff64 = 1 - (1 - 0.8467) * 0.369;
            cutoff16 = 1 - (1 - 0.9807) * 0.299;
            cutoff4 = 1 - (1 - 0.9902) * 0.199;
        } else if (radius >= 2538) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.525) * 0.699;
            cutoff64 = 1 - (1 - 0.8422) * 0.399;
            cutoff16 = 1 - (1 - 0.9802) * 0.299;
            cutoff4 = 1 - (1 - 0.9894) * 0.199;
        } else if (radius >= 1150) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.51) * 0.699;
            cutoff64 = 1 - (1 - 0.84) * 0.399;
            cutoff16 = 1 - (1 - 0.98) * 0.299;
            cutoff4 = 1 - (1 - 0.989) * 0.199;
        } else if (radius >= 725) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.17) * 0.799;
            cutoff64 = 1 - (1 - 0.8333) * 0.499;
            cutoff16 = 1 - (1 - 0.97) * 0.399;
            cutoff4 = 1 - (1 - 0.98) * 0.299;
        } else if (radius >= 300) {
            initialStep = 64;
            cutoff64 = 1 - (1 - 0.83) * 0.999;
            cutoff16 = 1 - (1 - 0.965) * 0.999;
            cutoff4 = 1 - (1 - 0.973) * 0.999;
        } else if (radius >= 100) {
            initialStep = 16;
            cutoff16 = 1 - (1 - 0.8) * 1;
            cutoff4 = 1 - (1 - 0.965) * 1;
