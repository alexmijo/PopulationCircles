...
class RasterDataCircleFinder {
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        double cutoff16;
        double cutoff4;
        constexpr double diff256 = 0.205;
        constexpr double diff64 = 0.140;
        constexpr double diff16 = 0.14;
        constexpr double diff4 = 0.145;
        if (radius >= 14100) {
            initialStep = 256;
