  ...
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        if (radius >= 14100) {
            ...
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6667) * 0.776;
            cutoff64 = 1 - (1 - 0.8833) * 0.331;
            cutoff16 = 1 - (1 - 0.9914) * 0.296;
            cutoff4 = 1 - (1 - 0.9969) * 0.251;
        } else if (radius >= 8850) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.65) * 1.776;
            cutoff64 = 1 - (1 - 0.875) * 1.351;
            cutoff16 = 1 - (1 - 0.98905) * 1.306;
            cutoff4 = 1 - (1 - 0.9958) * 1.261;
        } else if (radius >= 7775) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6167) * 1.786;
            cutoff64 = 1 - (1 - 0.865) * 1.371;
            cutoff16 = 1 - (1 - 0.9843) * 1.321;
            cutoff4 = 1 - (1 - 0.9937) * 1.271;
        } else if (radius >= 6700) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6) * 1.796;
            cutoff64 = 1 - (1 - 0.86) * 1.391;
            cutoff16 = 1 - (1 - 0.982) * 1.341;
            cutoff4 = 1 - (1 - 0.9926) * 1.291;
        } else if (radius >= 5313) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.57) * 1.796;
            cutoff64 = 1 - (1 - 0.8511) * 1.426;
            cutoff16 = 1 - (1 - 0.9811) * 1.376;
            cutoff4 = 1 - (1 - 0.991) * 1.296;
        } else if (radius >= 3925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.555) * 0.796;
            cutoff64 = 1 - (1 - 0.8467) * 0.466;
            cutoff16 = 1 - (1 - 0.9807) * 0.396;
            cutoff4 = 1 - (1 - 0.9902) * 0.296;
        } else if (radius >= 2538) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.525) * 1.796;
            cutoff64 = 1 - (1 - 0.8422) * 1.496;
            cutoff16 = 1 - (1 - 0.9802) * 1.396;
            cutoff4 = 1 - (1 - 0.9894) * 1.296;
        } else if (radius >= 1150) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.51) * 1.796;
            cutoff64 = 1 - (1 - 0.84) * 1.496;
            cutoff16 = 1 - (1 - 0.98) * 1.396;
            cutoff4 = 1 - (1 - 0.989) * 1.296;
        } else if (radius >= 725) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.17) * 1.896;
            cutoff64 = 1 - (1 - 0.8333) * 1.596;
            cutoff16 = 1 - (1 - 0.97) * 1.496;
            cutoff4 = 1 - (1 - 0.98) * 1.396;
        } else if (radius >= 300) {
            initialStep = 64;
            cutoff64 = 1 - (1 - 0.83) * 2.096;
            cutoff16 = 1 - (1 - 0.965) * 2.096;
            cutoff4 = 1 - (1 - 0.973) * 2.096;
        } else if (radius >= 100) {
            initialStep = 16;
            cutoff16 = 1 - (1 - 0.8) * 2.1;
            cutoff4 = 1 - (1 - 0.965) * 2.1;
        } else if (radius >= 20) {
            initialStep = 4;
            cutoff4 = 1 - (1 - 0.7) * 2.1;
        } else {
