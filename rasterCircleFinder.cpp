  ...
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        if (radius >= 14100) {
            ...
            cutoff64 = 1 - (1 - 0.8511) * 0.33;
            cutoff16 = 1 - (1 - 0.9811) * 0.28;
            cutoff4 = 1 - (1 - 0.991) * 0.2;
        } else if (radius >= 3925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.555) * 0.7;
            cutoff64 = 1 - (1 - 0.8467) * 0.37;
