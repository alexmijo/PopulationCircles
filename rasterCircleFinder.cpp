  ...
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        if (radius >= 14100) {
            ...
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6667) * 0.676;
            cutoff64 = 1 - (1 - 0.8833) * 0.231;
            cutoff16 = 1 - (1 - 0.9914) * 0.196;
            cutoff4 = 1 - (1 - 0.9969) * 0.151;
        } else if (radius >= 8850) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.65) * 0.676;
            cutoff64 = 1 - (1 - 0.875) * 0.251;
            cutoff16 = 1 - (1 - 0.98905) * 0.206;
            cutoff4 = 1 - (1 - 0.9958) * 0.161;
        } else if (radius >= 7775) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6167) * 0.686;
            cutoff64 = 1 - (1 - 0.865) * 0.271;
            cutoff16 = 1 - (1 - 0.9843) * 0.221;
            cutoff4 = 1 - (1 - 0.9937) * 0.171;
        } else if (radius >= 6700) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6) * 0.696;
            cutoff64 = 1 - (1 - 0.86) * 0.291;
            cutoff16 = 1 - (1 - 0.982) * 0.241;
            cutoff4 = 1 - (1 - 0.9926) * 0.191;
        } else if (radius >= 5313) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.57) * 0.696;
            cutoff64 = 1 - (1 - 0.8511) * 0.326;
            cutoff16 = 1 - (1 - 0.9811) * 0.276;
            cutoff4 = 1 - (1 - 0.991) * 0.196;
        } else if (radius >= 3925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.555) * 0.696;
            cutoff64 = 1 - (1 - 0.8467) * 0.366;
            cutoff16 = 1 - (1 - 0.9807) * 0.296;
            cutoff4 = 1 - (1 - 0.9902) * 0.196;
        } else if (radius >= 2538) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.525) * 0.696;
            cutoff64 = 1 - (1 - 0.8422) * 0.396;
            cutoff16 = 1 - (1 - 0.9802) * 0.296;
            cutoff4 = 1 - (1 - 0.9894) * 0.196;
        } else if (radius >= 1150) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.51) * 0.696;
            cutoff64 = 1 - (1 - 0.84) * 0.396;
            cutoff16 = 1 - (1 - 0.98) * 0.296;
            cutoff4 = 1 - (1 - 0.989) * 0.196;
        } else if (radius >= 725) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.17) * 0.796;
            cutoff64 = 1 - (1 - 0.8333) * 0.496;
            cutoff16 = 1 - (1 - 0.97) * 0.396;
            cutoff4 = 1 - (1 - 0.98) * 0.296;
        } else if (radius >= 300) {
            initialStep = 64;
            cutoff64 = 1 - (1 - 0.83) * 0.996;
            cutoff16 = 1 - (1 - 0.965) * 0.996;
            cutoff4 = 1 - (1 - 0.973) * 0.996;
        } else if (radius >= 100) {
            initialStep = 16;
            cutoff16 = 1 - (1 - 0.8) * 1;
            cutoff4 = 1 - (1 - 0.965) * 1;
