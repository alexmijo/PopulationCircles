  ...
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        if (radius >= 14100) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.9) * 1;
            cutoff64 = 1 - (1 - 0.99) * 0.5;
            cutoff16 = 1 - (1 - 0.9993) * 0.4;
            cutoff4 = 1 - (1 - 0.99993) * 0.3;
        } else if (radius >= 13910) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.8867) * 1;
            cutoff64 = 1 - (1 - 0.9633) * 0.5;
            cutoff16 = 1 - (1 - 0.9986) * 0.4;
            cutoff4 = 1 - (1 - 0.99985) * 0.3;
        } else if (radius >= 13750) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.88) * 1;
            cutoff64 = 1 - (1 - 0.95) * 0.5;
            cutoff16 = 1 - (1 - 0.9983) * 0.4;
            cutoff4 = 1 - (1 - 0.99984) * 0.3;
        } else if (radius >= 13625) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.8733) * 1;
            cutoff64 = 1 - (1 - 0.9433) * 0.5;
            cutoff16 = 1 - (1 - 0.9976) * 0.4;
            cutoff4 = 1 - (1 - 0.99983) * 0.3;
        } else if (radius >= 13500) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.87) * 1;
            cutoff64 = 1 - (1 - 0.94) * 0.5;
            cutoff16 = 1 - (1 - 0.9973) * 0.4;
            cutoff4 = 1 - (1 - 0.9998) * 0.3;
        } else if (radius >= 13250) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.8567) * 1;
            cutoff64 = 1 - (1 - 0.9333) * 0.5;
            cutoff16 = 1 - (1 - 0.9971) * 0.4;
            cutoff4 = 1 - (1 - 0.9996) * 0.3;
        } else if (radius >= 13000) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.85) * 1;
            cutoff64 = 1 - (1 - 0.93) * 0.5;
            cutoff16 = 1 - (1 - 0.997) * 0.4;
            cutoff4 = 1 - (1 - 0.9995) * 0.3;
        } else if (radius >= 12500) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.7833) * 1;
            cutoff64 = 1 - (1 - 0.9167) * 0.5;
            cutoff16 = 1 - (1 - 0.9967) * 0.4;
            cutoff4 = 1 - (1 - 0.9993) * 0.3;
        } else if (radius >= 12000) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.75) * 1;
            cutoff64 = 1 - (1 - 0.91) * 0.5;
            cutoff16 = 1 - (1 - 0.9965) * 0.4;
            cutoff4 = 1 - (1 - 0.9992) * 0.3;
        } else if (radius >= 11500) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.7167) * 1;
            cutoff64 = 1 - (1 - 0.9033) * 0.5;
            cutoff16 = 1 - (1 - 0.9962) * 0.4;
            cutoff4 = 1 - (1 - 0.9991) * 0.3;
        } else if (radius >= 11000) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.7) * 1;
            cutoff64 = 1 - (1 - 0.9) * 0.5;
            cutoff16 = 1 - (1 - 0.9961) * 0.4;
            cutoff4 = 1 - (1 - 0.9987) * 0.3;
        } else if (radius >= 9925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6667) * 0.9;
            cutoff64 = 1 - (1 - 0.8833) * 0.5;
            cutoff16 = 1 - (1 - 0.9914) * 0.4;
            cutoff4 = 1 - (1 - 0.9969) * 0.3;
        } else if (radius >= 8850) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.65) * 0.8;
            cutoff64 = 1 - (1 - 0.875) * 0.5;
            cutoff16 = 1 - (1 - 0.98905) * 0.4;
            cutoff4 = 1 - (1 - 0.9958) * 0.3;
        } else if (radius >= 7775) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6167) * 0.8;
            cutoff64 = 1 - (1 - 0.865) * 0.5;
            cutoff16 = 1 - (1 - 0.9843) * 0.4;
            cutoff4 = 1 - (1 - 0.9937) * 0.3;
        } else if (radius >= 6700) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6) * 0.8;
            cutoff64 = 1 - (1 - 0.86) * 0.5;
            cutoff16 = 1 - (1 - 0.982) * 0.4;
            cutoff4 = 1 - (1 - 0.9926) * 0.3;
        } else if (radius >= 5313) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.57) * 0.8;
            cutoff64 = 1 - (1 - 0.8511) * 0.5;
            cutoff16 = 1 - (1 - 0.9811) * 0.4;
            cutoff4 = 1 - (1 - 0.991) * 0.3;
        } else if (radius >= 3925) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.555) * 0.8;
            cutoff64 = 1 - (1 - 0.8467) * 0.5;
            cutoff16 = 1 - (1 - 0.9807) * 0.4;
            cutoff4 = 1 - (1 - 0.9902) * 0.3;
        } else if (radius >= 2538) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.525) * 0.8;
            cutoff64 = 1 - (1 - 0.8422) * 0.5;
            cutoff16 = 1 - (1 - 0.9802) * 0.4;
            cutoff4 = 1 - (1 - 0.9894) * 0.3;
        } else if (radius >= 1150) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.51) * 0.8;
            cutoff64 = 1 - (1 - 0.84) * 0.5;
            cutoff16 = 1 - (1 - 0.98) * 0.4;
            cutoff4 = 1 - (1 - 0.989) * 0.3;
        } else if (radius >= 725) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.17) * 0.8;
            cutoff64 = 1 - (1 - 0.8333) * 0.5;
            cutoff16 = 1 - (1 - 0.97) * 0.4;
            cutoff4 = 1 - (1 - 0.98) * 0.3;
        } else if (radius >= 300) {
            initialStep = 64;
            cutoff64 = 1 - (1 - 0.83) * 1;
