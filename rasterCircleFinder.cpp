  ...
  private:
    ...
    CircleResultMaybeShortCircuit shortCircuitingMostPopulousCircleOfGivenRadius(
        ...
        if (radius >= 14100) {
            ...
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.65) * 0.776;
            cutoff64 = 1 - (1 - 0.875) * 0.351;
            cutoff16 = 1 - (1 - 0.98905) * 0.306;
            cutoff4 = 1 - (1 - 0.9958) * 0.261;
        } else if (radius >= 7775) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6167) * 0.786;
            cutoff64 = 1 - (1 - 0.865) * 0.371;
            cutoff16 = 1 - (1 - 0.9843) * 0.321;
            cutoff4 = 1 - (1 - 0.9937) * 0.271;
        } else if (radius >= 6700) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.6) * 0.796;
            cutoff64 = 1 - (1 - 0.86) * 0.391;
            cutoff16 = 1 - (1 - 0.982) * 0.341;
            cutoff4 = 1 - (1 - 0.9926) * 0.291;
        } else if (radius >= 5313) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.57) * 0.796;
            cutoff64 = 1 - (1 - 0.8511) * 0.426;
            cutoff16 = 1 - (1 - 0.9811) * 0.376;
            cutoff4 = 1 - (1 - 0.991) * 0.296;
        } else if (radius >= 3925) {
            initialStep = 256;
            ...
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.525) * 0.796;
            cutoff64 = 1 - (1 - 0.8422) * 0.496;
            cutoff16 = 1 - (1 - 0.9802) * 0.396;
            cutoff4 = 1 - (1 - 0.9894) * 0.296;
        } else if (radius >= 1150) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.51) * 0.796;
            cutoff64 = 1 - (1 - 0.84) * 0.496;
            cutoff16 = 1 - (1 - 0.98) * 0.396;
            cutoff4 = 1 - (1 - 0.989) * 0.296;
        } else if (radius >= 725) {
            initialStep = 256;
            cutoff256 = 1 - (1 - 0.17) * 0.896;
            cutoff64 = 1 - (1 - 0.8333) * 0.596;
            cutoff16 = 1 - (1 - 0.97) * 0.496;
            cutoff4 = 1 - (1 - 0.98) * 0.396;
        } else if (radius >= 300) {
            initialStep = 64;
            cutoff64 = 1 - (1 - 0.83) * 1.096;
            cutoff16 = 1 - (1 - 0.965) * 1.096;
            cutoff4 = 1 - (1 - 0.973) * 1.096;
        } else if (radius >= 100) {
            initialStep = 16;
            cutoff16 = 1 - (1 - 0.8) * 1.1;
            cutoff4 = 1 - (1 - 0.965) * 1.1;
        } else if (radius >= 20) {
            initialStep = 4;
            cutoff4 = 1 - (1 - 0.7) * 1.1;
        } else {
